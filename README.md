...
**Stats**: 38 pages / 52 routes / 25 SQL query files / 14 API routes / 125 MCP tools (8 Gateways) / 17 components
...
**현황**: 38 페이지 / 52 라우트 / 25 SQL 쿼리 파일 / 14 API 라우트 / 125 MCP 도구 (8 Gateway) / 17 컴포넌트
